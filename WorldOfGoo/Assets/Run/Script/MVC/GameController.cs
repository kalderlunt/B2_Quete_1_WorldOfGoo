...
public class GameController : MonoBehaviour
{
    ...
    private void CreateBallsAndSprings()
    {
        ...
        BallModel       ball1Model      = new (new Vector2(-5, 0), 1.0f);
        BallView        ball1View       = ball1Object.GetComponent<BallView>();
        ball1View.Initialize(ball1Model, ball1Object.GetComponent<SpriteRenderer>());
        ...
        BallModel       ball2Model      = new (new Vector2(5, 0), 1.0f);
        BallView        ball2View       = ball2Object.GetComponent<BallView>();
        ball2View.Initialize(ball2Model, ball2Object.GetComponent<SpriteRenderer>());
